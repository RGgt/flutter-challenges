...
spoiler_text: |
    To do it, you will need to use some sort of state management library. <BR/>**DO NOT CALL setState() DIRECTLY**!<BR/><BR/> <a href="https://docs.flutter.dev/development/data-and-backend/state-mgmt/options" target="_blank">See a list of state management libaries for Flutter here.</a>
